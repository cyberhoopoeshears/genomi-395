...
```bash
git clone https://github.com/cyberhoopoeshears/genomi-395.git
cd genomi-395
python setup.py
```
...
if anything below drifts from it, that doc wins.
   ...
   ```bash
   git clone git@github.com:cyberhoopoeshears/genomi-395.git ~/.genomi/genomi
   cd ~/.genomi/genomi
   ```
...
- [1000 Genomes 30x GRCh38](https://www.internationalgenome.org/data-portal/data-collections/30x-grch38.html) —
  ...
  the [genomi-ancestry-panel](https://github.com/cyberhoopoeshears/genomi-395-ancestry-panel)
...
<!-- Last updated: 2026-06-06 14:47:39 -->
